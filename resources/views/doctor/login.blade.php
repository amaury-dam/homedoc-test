    ...
    <div class="container login-box">
        <div class="row">
            <div class="col-md-4 login-sec">
                ...
                <form method="post" style="padding: 20px; border-bottom: 1px solid rgba(0,0,0,.125);" class="login-form" action="{!! url('doctor/login') !!}">
                ...
                <div style="text-align: center;">
                    <a class="btn btn-dark"  href="{{ url('doctor/firstLogin') }}"  style="margin-top: 15px;" ><i class="fas fa-edit"></i>Première connexion</a>
                </div>
            </div>
